...
from core.views import index, nosotros, tienda, contacto, donaciones, administrador, agregar_prod, modificar_prod
...
urlpatterns = [
    ...
    path('modificar_prod.html', modificar_prod,name="modificar_prod"),
